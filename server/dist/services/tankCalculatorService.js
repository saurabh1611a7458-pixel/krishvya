...
export function evaluateChemicalCompatibility(chemAId, chemBId) {
    ...
    if ((a.id === 'copper_oxychloride' && b.id === 'chlorpyrifos') ||
        (b.id === 'copper_oxychloride' && a.id === 'chlorpyrifos')) {
        return {
            status: 'DANGEROUS',
            title: 'DANGEROUS COCKTAIL: Copper + Organophosphate',
            explanation: 'DO NOT MIX! Copper Oxychloride is strongly alkaline. It rapidly hydrolyzes Chlorpyrifos, neutralizing its pest-killing power and creating a toxic curdled precipitate that burns plant foliage and clogs spray nozzles.',
            farmerWarningHindi: '⚠️ सख्त मना है! कॉपर ऑक्सीक्लोराइड और क्लोरपायरीफॉस को कभी न मिलाएं! यह घोल दूध की तरह फट जाएगा, पत्तियों को जला देगा और नोजल जाम कर देगा।',
    ...
    if ((a.id === 'trichoderma' && (b.category === 'Fungicide' && !b.isOrganic)) ||
        (b.id === 'trichoderma' && (a.category === 'Fungicide' && !a.isOrganic))) {
        return {
            status: 'DANGEROUS',
            title: 'INCOMPATIBLE: Bio-agent + Chemical Fungicide',
            explanation: 'DO NOT MIX! Trichoderma is a living beneficial fungus. The chemical fungicide will kill 100% of the Trichoderma spores in the tank, rendering your bio-agent completely useless and wasting money.',
            farmerWarningHindi: '⚠️ ट्राइकोडर्मा को किसी भी रासायनिक फफूंदनाशक के साथ न मिलाएं! रासायनिक दवा जीवित ट्राइकोडर्मा को तुरंत मार देगी।',
    ...
    if ((a.id === 'calcium_nitrate' && (b.id === 'npk_19_19_19' || b.id === 'boron_20')) ||
        (b.id === 'calcium_nitrate' && (a.id === 'npk_19_19_19' || a.id === 'boron_20'))) {
        return {
            status: 'CAUTION',
            title: 'Precipitation Risk: Calcium + Phosphates',
            explanation: 'CAUTION! Calcium reacts with phosphates/sulphates to form insoluble white gypsum chalk flakes that deposit at the bottom of the tank and clog your knapsack pump filter.',
            farmerWarningHindi: 'सावधानी: कैल्शियम और फास्फेट को एक साथ मिलाने से नीचे सफेद चूना जम सकता है। अलग-अलग घोलें।',
    ...
    if ((a.id === 'mancozeb' && b.id === 'carbendazim') ||
        (b.id === 'mancozeb' && a.id === 'carbendazim')) {
        return {
            status: 'SAFE',
            title: 'SAFE COMBINATION: Dual-Action Fungicide (Contact + Systemic)',
            explanation: 'Highly effective combination (popularly known as Saaf formulation). Mancozeb protects leaf surfaces from outside, while Carbendazim enters the plant sap to eradicate deep fungal infections.',
            farmerWarningHindi: '✅ बहुत सुरक्षित और असरदार! मैंकोजेब और कार्बेन्डाजिम का मिश्रण पत्तों को बाहर और अंदर दोनों तरफ से सुरक्षित करता है।',
    ...
    if ((a.id === 'npk_19_19_19' && b.id === 'imidacloprid') ||
        (b.id === 'npk_19_19_19' && a.id === 'imidacloprid')) {
        return {
            status: 'SAFE',
            title: 'SAFE COMBINATION: Foliar Nutrition + Sucking Pest Control',
            explanation: 'Compatible tank mix. Provides quick greening through 19:19:19 while simultaneously eliminating whiteflies and aphids through systemic Imidacloprid.',
            farmerWarningHindi: '✅ सुरक्षित मिश्रण! 19:19:19 खाद और कॉनफिडोर को एक साथ मिलाकर छिड़काव किया जा सकता है।',
    ...
    return {
        ...
        explanation: 'These two formulations can generally be tank-mixed. However, water hardness or temperature variations in your village can alter dissolution. Always perform a 2-minute test in a small cup before full tank preparation.',
        farmerWarningHindi: 'सावधानी: दोनों को मिला सकते हैं, लेकिन पहले 1 गिलास पानी में दोनों की 1-1 बूंद डालकर देख लें।',
...
export function calculateSprayTankDose(chemicalId, secondaryChemicalId = '', tankCapacityLiters = 15, farmAcres = 2.5) {
    ...
    const totalChemicalNeeded = chem.unit === 'g'
    ...
    return {
        ...
        zeroCostOrganicAlternative: {
            ...
            recipe: 'Pound 500g dried neem seeds, soak in 10L water overnight, filter through khadi cloth, add 20g soap solution as sticker. Pour into your 15L knapsack pump.',
